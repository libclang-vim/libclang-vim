...
const char* libclang_vim::get_extent(const libclang_vim::location_tuple& location_info, const std::function<unsigned(CXCursor)>& predicate)
{
    return at_specific_location(
                location_info,
                [&predicate](const CXCursor& c) -> std::string
                {
...
const char* libclang_vim::get_related_node_of(const libclang_vim::location_tuple& location_info, const std::function<CXCursor(CXCursor)>& predicate)
{
    return at_specific_location(
                location_info,
...
const char* libclang_vim::get_type_related_to(const libclang_vim::location_tuple& location_info, const std::function<CXType(CXType)>& predicate)
{
    return at_specific_location(
            location_info,
            [&predicate](CXCursor const& c) -> std::string
...
const char* libclang_vim::get_all_extents(const libclang_vim::location_tuple& location_info)
{
